...
post:
  ...
  comments_count: null
  reposts: null
  theme: "AWS RDS cost optimization"
  angle: "Database Savings Plans and SQL Server Developer Edition"
  key_points:
    - "AWS re:Invent deep dive on Database Savings Plans"
    - "SQL Server Developer Edition for RDS"
...
- id: 1734260700000
  type: "reply"
  reply_to: "Jordan Dea-Mattson comment"
  status: "posted"
