...
subtitle: "Should you switch from self-managed ArgoCD to AWS's new managed offering? We analyzed the trade-offs so you don't have to."
cover_image: "2025-12-13__eks-capabilities-cover-dark-3x.png"
...
research_sources:
  ...
  - https://docs.aws.amazon.com/eks/latest/userguide/capabilities-considerations.html
  - https://cloud.google.com/blog/products/containers-kubernetes/introducing-kube-resource-orchestrator
  - https://dev.to/aws-builders/i-created-s3-buckets-using-argocd-ack-with-eks-capabilities-no-controllers-installed-cm0
  - https://siliconangle.com/2025/12/01/aws-unveils-eks-capabilities-reinvent-kubernetes-operations-ai-workloads-surge/
...
We'll continue exploring platform engineering topics in our **Builds that Last** publication:

- **EKS deep dives**: Migration strategies, cost modeling, architecture patterns
- **GitOps at scale**: Multi-cluster patterns, progressive delivery, environment management
- **Infrastructure as Code**: Terraform patterns, testing strategies, drift detection
- **Platform team playbooks**: Building internal developer platforms that work
- **Observability**: Monitoring, logging, and tracing for Kubernetes workloads

If you're building platforms that need to scale, this is where we share what we're learning along the way.

*Have questions or want to share your experience with EKS Capabilities? Let us know in the comments.*


**Poll: What's your plan for EKS Capabilities?**
- Adopting now / soon
- Waiting for more features
- Staying with self-managed
- Not using EKS
